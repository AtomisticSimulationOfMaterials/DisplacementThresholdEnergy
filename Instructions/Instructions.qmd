---
title: "Instructions for displacement threshold energy exercise"
execute:
  echo: false
jupyter: python3
format: html
...
Select `01-DisplacementThreshold/01-DisplacementThreshold.ipynb`. You'll be asked a couple of questions. Confirm you want to proceed you'll then see the notebook in Colab as in @fig-colab1
